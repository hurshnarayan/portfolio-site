  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive attendance management system featuring real-time QR code rotation and device binding for security.",
      bullets: [
    ...
    <div className="projects-page-timeline">
      <div className="timeline-container">
        <div className="timeline-header">
          ...
          <p>
            I've been building projects and learning new technologies. Here's a
            timeline of my work.
          </p>
        </div>
